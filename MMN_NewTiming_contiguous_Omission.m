...
filename = ['ke105106022']; % file name for current run
% Define the probability of a deviant stimulus
deviantProbability1 = 0.07; % 
...
%  write to text files
generate_trials_contiguous_Omission(standardParams, deviantParams1, deviantProbability1, interstimulusInterval, numTrials, paramsDir);
