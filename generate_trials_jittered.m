function generate_trials_jittered(standardParams, deviantParams1, deviantProbability1, x, numTrials, paramsDir)
    ...
    if numDeviants >deviantProbability1 * numTrials
        numDeviants = floor(deviantProbability1 * numTrials);
    end
