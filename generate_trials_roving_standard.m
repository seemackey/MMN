function generate_trials_roving_standard(standardParams, deviantParams1, deviantProbability1, interstimulusInterval, numTrials, paramsDir)
...
%         trialTypes{trialIdx} = 'D';
    ...
    for i=1:2:numDeviants1
      XX{i}=  deviantIndices(i):deviantIndices(i)+ SS(i)-1;
    end
