...
standardParams = struct('ToneAmp', 0.2, 'ToneFreq', 32000, 'ToneDur', 100, 'ModAmp', 1, 'ModFreq', 20, 'ID_SweepTime', 100, 'ID_F1', 1000, 'ID_F2', 4000, 'StimType', 0); 

% Define the parameters for deviant stimulus. %Stimtype #0 is umodulated tone,#1 is AM and #2 is FM
deviantParams = struct('ToneAmp', 0.2, 'ToneFreq', 2000, 'ToneDur', 100, 'ModAmp', 1, 'ModFreq', 20, 'ID_SweepTime', 300, 'ID_F1', 1000, 'ID_F2', 4000, 'StimType', 0);

% Define the probability of a deviant stimulus
deviantProbability = 0.1; %should be 0.1
